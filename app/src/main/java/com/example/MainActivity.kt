                    ...
                    drawerContent = {
                        TaskHistorySidebarDrawer(
                            ...
                            onSubmitCorrection = { correctionText ->
                                viewModel.submitAgentCorrection(correctionText)
                            },
                            onClearHistory = {
                            ...
                            Column(modifier = Modifier.fillMaxWidth()) {
                                ...
                                ScrollableTabRow(
                                    ...
                                    Tab(
                                        ...
                                        icon = {
                                            Icon(Icons.Default.Campaign, contentDescription = "Radar & News")
                                        },
                                        text = { Text("Radar & News") },
                                        selectedContentColor = SproutPrimary,
                                        unselectedContentColor = SproutTextMuted,
                                    ...
                                    Tab(
                                        ...
                                        onClick = { focusManager.clearFocus(); viewModel.setSelectedTab(7) },
                                        icon = {
                                            BadgedBox(
                                                badge = {
                        ...
                        Box(
                            ...
                            AnimatedContent(
                                ...
                                when (tab) {
                                    ...
                                    6 -> RoutinesAndRadarScreen(
                                        onBroadcastTelegram = { text ->
                                            viewModel.sendTelegramBroadcast(text)
                                        },
                                        onDelegateAgentTask = { taskText ->
                                            viewModel.executeUserCommand(taskText)
                                        }
                                    )
